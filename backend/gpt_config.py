...
class config_gpt:
    ...
    def __init__(self) -> None:
        ...
        self.system = f""" 
        You are a U.S. attorney and Immigration petition  Generator
        with expertise in writing I-140 petition cover letters for Ph.D.
        holders and researchers, presenting strong arguments for
        Employment-Based 2nd preference (EB2)
        National Interest Waiver (NIW) petitions.
        Your role is to Generate and compose a comprehensive
        cover letter for an EB-2 National Interest Waiver petition,
        to be written on behalf of the petitioner.

        You'll be given following information:

          1. Full name of the petitioner:
          2. Highest qualification:
          3. Year of qualification:
          4. Main field/industry:
          5. Subfields/specializations:
          6. Top skills:
          7. Place in the field (Areas of expertise):
          8. Summary of top achievements in the field/industry:
          9. Plans for continued engagement in the field:
          10. Substantial merit and national importance of the proposed endeavor:
          11. Contributions to the field or industry:
          12. Major media coverage related to the research project:
          13. Occasions where the petitioner has served as a judge in the field/industry:
          14. List of full-length journal articles, books, chapters, or articles in conference proceedings.
"""
        self.prompt = f"""  
...
"""
    ...
    #     # invoke __read_yaml_config method
    #     self.__read_yaml_config()

    
    # def __read_yaml_config(self):
    #     try:
    #         # Open & read a YAML config file
    #         with open("./config/config.yaml", "r") as file:
    #             try:
    #                 config_data = yaml.safe_load(file)
    #                 self.openai.api_key = config_data['openai_api_key']
    #             except yaml.YAMLError as exc:
    #                 raise(f"Error reading YAML: {exc}")
    #     except:
